  ...
  return (
    <div className="bg-primary-container fixed inset-0 overflow-hidden text-on-surface select-none dark selection:bg-secondary-container selection:text-on-secondary-container">
      <div
        ...
        style={{
          backgroundImage:
            "url('https://lh3.googleusercontent.com/aida-public/AB6AXuDVubUd1SN_PAJv5SV1OT_D_9nP-YAgeIh5qeuJBzzLrYmK58Ig7Crgvi1_63-JqTWaUrgW1qm0H6GOxLbmaVYa_EPx7q3qwAEWIamj_P7Tm_KGNDMI6nKKkCyP1DDPzKHInwaqUDM95buKLjn1Gkjpp4rOz2V4NWuAUO0FlJirms8o-6GtatEZJRm3ql9VR3NuUsVNbGncvr8nl6dzyQaOTXrJJ1i0QJ5HhoLGsChiao3wPUjo4eft')",
